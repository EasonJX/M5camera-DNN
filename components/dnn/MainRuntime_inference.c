...
typedef struct {
    ...
    int v5_shape[2];
    rt_variable_t v6; ///< Tanh
    int v6_shape[2];
    rt_variable_t v7; ///< Affine_2
    int v7_shape[2];
    rt_variable_t v8; ///< Softmax
    int v8_shape[2];
