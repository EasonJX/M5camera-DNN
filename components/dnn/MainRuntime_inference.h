...
#define NNABLART_MAINRUNTIME_PARAM0_SIZE (17248)
#define NNABLART_MAINRUNTIME_PARAM1_SIZE (22)
#define NNABLART_MAINRUNTIME_PARAM2_SIZE (220)
#define NNABLART_MAINRUNTIME_PARAM3_SIZE (10)
/// Pointer of allocated buffer.
